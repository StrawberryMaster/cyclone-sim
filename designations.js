...
DesignationSystem.PAGASA = new DesignationSystem({
    ...
    nameThresh: 0,
    mainLists: [
        ["Auring", "Bising", "Crising", "Dante", "Emong", "Fabian", "Gorio", "Huaning", "Isang", "Jacinta", "Kiko", "Lannie", "Mirasol", "Nando", "Opong", "Paolo", "Quedan", "Ramil", "Salome", "Tino", "Uwan", "Verbena", "Wilma", "Yasmin", "Zoraida", "Alamid", "Bruno", "Conching", "Dolor", "Ernie", "Florante", "Gerardo", "Hernan", "Isko", "Jerome"],
...
DesignationSystem.australianRegionBoM = new DesignationSystem({
    ...
    mainLists: [
        ...
        ["Amber", "Blake", "Claudia", "Declan", "Esther", "Ferdinand", "Gretel", "Heath", "Imogen", "Joshua", "Kimi", "Lucas", "Marian", "Niran", "Odette", "Paddy", "Ruby", "Seth", "Tiffany", "Vernon"]
    ]
});
...
DesignationSystem.australianRegionJakarta = new DesignationSystem({
    ...
    numEnable: false,
    mainLists: [
        ['Anggrek', 'Bakung', 'Cempaka', 'Dahlia', 'Flamboyan', 'Kenanga', 'Lili', 'Melati', 'Rembutan', 'Teratai']
    ],
    replacementLists: [
...
DesignationSystem.southWestIndianOcean = new DesignationSystem({
    ...
    anchor: 2017,
    mainLists: [
        ['Ashley', 'Balita', 'Cheneso', 'Dingani', 'Enala', 'Fabien', 'Gezani', 'Horacio', 'Indusa', 'Juluka', 'Kundai', 'Lisebo', 'Michel', 'Nousra', 'Olivier', 'Pokera', 'Quincy', 'Rebaone', 'Salama', 'Tristan', 'Ursula', 'Violet', 'Wilson', 'Xila', 'Yekela', 'Zania'],
...
DesignationSystem.southPacific = new DesignationSystem({
    ...
    suffix: 'F',
    mainLists: [
        ['Aru', 'Bina', 'Cody', 'Dovi', 'Eva', 'Fili', 'Gina', 'Hale', 'Irene', 'Judy', 'Kevin', 'Lola', 'Mal', 'Nat', 'Osai', 'Pita', 'Rae', 'Seru', 'Tam', 'Urmil', 'Vaianu', 'Wati', 'Xavier', 'Yani', 'Zita'],
    ...
    replacementLists: [
        ['Adama', 'Ben', 'Carol', 'Dakai', 'Emosi', 'Feki', 'Germaine', 'Hart', 'Ili', 'Josese', 'Kirio', 'Lute', 'Mata', 'Neta', 'Olina', 'Paea', 'Rex', 'Sete', 'Temo', 'Uila', 'Velma', 'Wane', 'Yavala', 'Zanna']
    ]
});
...
DesignationSystem.periodicTable = new DesignationSystem({
    ...
    mainLists: [
        ["Hydrogen", "Helium", "Lithium", "Beryllium", "Boron", "Carbon", "Nitrogen", "Oxygen", "Fluorine", "Neon", "Sodium", "Magnesium", "Aluminium", "Silicon", "Phosphorus", "Sulfur", "Chlorine", "Argon",
            ...
            "Lutetium", "Hafnium", "Tantalum", "Tungsten", "Rhenium", "Osmium", "Iridium", "Platinum", "Gold", "Mercury", "Thallium", "Lead", "Bismuth", "Polonium", "Astatine", "Radon", "Francium", "Radium", "Actinium",
            "Thorium", "Protactinium", "Uranium", "Neptunium", "Plutonium", "Americium", "Curium", "Berkelium", "Californium", "Einsteinium", "Fermium", "Mendelevium", "Nobelium", "Lawrencium", "Rutherfordium", "Dubnium",
