...
const NHEM_DEFAULT_YEAR = DateTime.utc().year;
const SHEM_DEFAULT_YEAR = DateTime.utc().month < 6 ? NHEM_DEFAULT_YEAR : NHEM_DEFAULT_YEAR + 1;
...
const ENVDATA_NOT_FOUND_ERROR = "ERROR: no environment data found. Please check your installation.";
const LOADED_SEASON_REQUIRED_ERROR = "ERROR: no loaded season found. Please check your installation.";
